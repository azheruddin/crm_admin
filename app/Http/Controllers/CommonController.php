...
class CommonController extends Controller
{
    ...
    $total = $uniqueOutgoingCallsToday + $incoming + $missed + $unknown;
        ...
        return view('dashboard', compact('totalEmployees', 'activeEmployees', 'deactivatedEmployees','totalLeads', 'hotLeads', 'interested', 'notInterested','uniqueOutgoingCallsToday', 'incoming', 'missed','unknown', 'total'));
    }
